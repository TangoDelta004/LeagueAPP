...
key = 'RGAPI-cab7bc14-8891-428a-b8cb-a2dc1848abb0'
...
function dostuff(res, post) {
    ...
    getrequest(url, (error, data) => {
        ...
        getrequest(url, (error, data) => {
            ...
            console.log("BEST CHAMP MASTERY: " + bestchampmastery)

            totalchampmastery = numberWithCommas(totalchampmastery)
            console.log("TOTAL CHAMP MASTERY: " + totalchampmastery)
